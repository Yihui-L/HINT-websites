...
- [庞加莱 · 第70步总场 · 三截面](poincare_final_three_sections.png)
- [庞加莱 · 初始真空场 · 三截面](poincare_initial_three_sections.png)
...
- [响应场 分量插值器 JAX AD 散度](convergence_ad_response.png)
- [总场 分量插值器 JAX AD 散度](convergence_ad_total.png)
- [真空场 分量插值器 JAX AD 散度](convergence_ad_vacuum.png)
...
- [响应场 HINT 网格四阶差分 散度](convergence_fd4_response.png)
- [总场 HINT 网格四阶差分 散度](convergence_fd4_total.png)
- [真空场 HINT 网格四阶差分 散度](convergence_fd4_vacuum.png)
- [末态插值场高精度散度核验](convergence_final_divergence_precision.png)
- [Step-B存储诊断 · 01](convergence_stepb_01.png)
- [Step-B存储诊断 · 02](convergence_stepb_02.png)
- [Step-B存储诊断 · 03](convergence_stepb_03.png)
- [每次外迭代实际耗时](convergence_wall_clock_timings.png)
- [庞加莱 · 第70步总场 · 0°](poincare_final_phi_000.png)
- [庞加莱 · 第70步总场 · 30°](poincare_final_phi_030.png)
- [庞加莱 · 第70步总场 · 60°](poincare_final_phi_060.png)
- [庞加莱 · 初始真空场 · 0°](poincare_initial_phi_000.png)
- [庞加莱 · 初始真空场 · 30°](poincare_initial_phi_030.png)
- [庞加莱 · 初始真空场 · 60°](poincare_initial_phi_060.png)
