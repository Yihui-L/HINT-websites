...
OUT=(CASE/'run/postprocess-step070-complete').resolve()
p=HintPlots(CASE/'run/hint_debug_ncsx_zero.nc',outer_step=70,backend='gpu',engine='jax')
...
result={'outer_step':70,'interpolation':'component','derivative':'float64 JAX jacfwd',
...
fig.suptitle('NCSX | outer 70 | float64 JAX AD of actual component interpolant\n'
