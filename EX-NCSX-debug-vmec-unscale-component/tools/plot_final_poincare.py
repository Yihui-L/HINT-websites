...
metadata = dict(
    source=str(plots.path), outer_step=50, turns=turns, nfp=int(grid.nfp),
...
for selected, stem in [(rows, "final_poincare_wall_coverage")] + [
    ...
    result.figure.suptitle(
        "NCSX | final outer step 50 | total magnetic field\n"
